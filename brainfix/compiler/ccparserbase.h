...
// $insert polymorphicSpecializations
    template <>
    struct TagOf<std::vector<int>>
    {
        static Tag__ const tag = Tag__::LIST;
    };

    template <>
    struct TagOf<std::pair<std::string, std::vector<int>>>
    {
        static Tag__ const tag = Tag__::PAIR2;
    };

    template <>
    struct TagOf<std::pair<int, int>>
    {
        static Tag__ const tag = Tag__::PAIR1;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::PAIR2>
    {
        typedef std::pair<std::string, std::vector<int>> DataType;
    };

    template <>
    struct TypeOfBase<Tag__::PAIR1>
    {
